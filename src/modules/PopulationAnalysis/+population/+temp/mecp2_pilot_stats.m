function fig = mecp2_pilot_stats()
    ...
    stats.similarity = population.temp.rankSubjectSimilarityToBaseline(c57Data, mecp2Data, ...
    ...
    stats.similarityFigure = population.temp.plotSimilarityToBaseline(c57Data, mecp2Data, ...
        "ProgressionMetricType", "state", ...
        "BinWidth", BIN_WIDTH, ...
        "MeanWindowFrames", MEAN_WINDOW_FRAMES, ...
        "OutputDir", string(outputDir), ...
