function fig = shank3_pilot_stats()

    % Male KO Shank3
    % SHANK3_DATA_PATH = "D:/JOBS/WashU_Neuroscience/Behavior/WU-SMAC/PlacePreference/POPULATION/In-House/Shank3/20260824_standardizedTables__MALE_KO_ONLY_n=7.mat";
    % Or, Male HET Shank3
    SHANK3_DATA_PATH = "D:/JOBS/WashU_Neuroscience/Behavior/WU-SMAC/PlacePreference/POPULATION/In-House/Shank3/20260824_standardizedTables__MALE_HET_ONLY_n=14.mat";

    % Male C57 WT data for comparison
    C57_DATA_PATH = "D:/JOBS/WashU_Neuroscience/Behavior/WU-SMAC/PlacePreference/POPULATION/In-House/C57/20260611_standardizedTable_MalesOnly+Baseline__SLEAP__NO_OUTLIER__n=15.mat";

    OUTPUTDIR = "D:/JOBS/WashU_Neuroscience/Behavior/WU-SMAC/PlacePreference/POPULATION/In-House/Shank3/Prelim/Shank3_HET_vs_C57_WT";

    shank3Data = load(SHANK3_DATA_PATH).standardizedTables;
    c57Data = load(C57_DATA_PATH).standardizedTables;
    ...
    fig = struct( ...
        'Name', "Male SHANK3 HET vs. Male C57 WT", ...
    ...
    mergedTable(1) = population.temp.joinStdTableByStim(shank3Data(1), c57Data(1), 'EmbeddedNAnimalA', true);
    mergedTable(2) = population.temp.joinStdTableByStim(shank3Data(2), c57Data(2), 'EmbeddedNAnimalA', true);
    ...
    outputDir = fullfile(OUTPUTDIR, 'outputs', ['shank3_pilot_stats_' runStamp]);
    if ~exist(outputDir, 'dir')
        mkdir(outputDir);
    end
    logTxtPath = fullfile(outputDir, ['shank3_pilot_stats_' runStamp '_command_window.log']);
    diary(logTxtPath);
    diary on;
