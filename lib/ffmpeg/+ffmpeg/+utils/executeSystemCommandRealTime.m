function [exitCode] = executeSystemCommandRealTime(command, stdoutCallback)
%%EXECUTESYSTEMCOMMANDREALTIME Executes a system command and prints stdout in real-time.
